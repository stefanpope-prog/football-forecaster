...
Generated 2026-06-24 22:58 UTC. Paste this whole document into Claude Chat, then ask any question about the upcoming fixtures.
...
- **W / D / L:** 100% / 0% / 0%
- **lambda_home / lambda_away:** 8.75 / 0.22
- **Top scorelines:**
  - 8:0 (22%)
  - 7:0 (20%)
  - 6:0 (16%)
...
- **Why:** MAR is the clear favourite. Recent form (last 5): MAR 2 wins, 3 draws; HAI 2 wins, 1 draw, 2 losses. Model gives MAR 100%, draw 0%, HAI 0%.


### SCO vs BRA - Wed 24 Jun 22:00 UTC

- **Stage:** GROUP
- **Recommended pick (EV-optimal):** 0-8 (EV ~ 4.32 pts)
- **W / D / L:** 0% / 0% / 100%
- **lambda_home / lambda_away:** 0.21 / 8.96
- **Top scorelines:**
  - 0:8 (23%)
  - 0:7 (21%)
  - 0:6 (16%)
...
- **Why:** BRA is the clear favourite. Recent form (last 5): SCO 2 wins, 3 losses; BRA 3 wins, 1 draw, 1 loss. Past 3 meetings: BRA won 3. Model gives SCO 0%, draw 0%, BRA 100%.
...
- **W / D / L:** 0% / 0% / 100%
- **lambda_home / lambda_away:** 0.19 / 10.09
- **Top scorelines:**
  - 0:8 (28%)
  - 0:7 (22%)
  - 0:6 (16%)
...
- **W / D / L:** 1% / 5% / 93%
- **lambda_home / lambda_away:** 0.48 / 3.97
- **Top scorelines:**
  - 0:3 (12%)
  - 0:4 (12%)
  - 0:5 (10%)
...
- **W / D / L:** 0% / 2% / 98%
- **lambda_home / lambda_away:** 0.35 / 5.38
- **Top scorelines:**
  - 0:5 (13%)
  - 0:4 (12%)
  - 0:6 (12%)
...
- **W / D / L:** 2% / 6% / 93%
- **lambda_home / lambda_away:** 0.49 / 3.86
- **Top scorelines:**
  - 0:3 (13%)
  - 0:4 (12%)
  - 0:2 (10%)
...
- **W / D / L:** 0% / 0% / 100%
- **lambda_home / lambda_away:** 0.22 / 8.51
- **Top scorelines:**
  - 0:8 (21%)
  - 0:7 (20%)
  - 0:6 (16%)
...
- **Why:** NED is the clear favourite. Recent form (last 5): TUN 1 win, 1 draw, 3 losses; NED 2 wins, 2 draws, 1 loss. Past 3 meetings: drew 2, NED won 1. Model gives TUN 0%, draw 0%, NED 100%.


### JPN vs SWE - Thu 25 Jun 23:00 UTC

- **Stage:** GROUP
- **Recommended pick (EV-optimal):** 7-0 (EV ~ 4.26 pts)
- **W / D / L:** 100% / 0% / 0%
- **lambda_home / lambda_away:** 8.15 / 0.23
- **Top scorelines:**
  - 8:0 (19%)
  - 7:0 (19%)
  - 6:0 (16%)
...
- **Why:** JPN is the clear favourite. Recent form (last 5): JPN won all 5; SWE 2 wins, 1 draw, 2 losses. Past 3 meetings: drew 2, SWE won 1. Model gives JPN 100%, draw 0%, SWE 0%.
...
- **Recommended pick (EV-optimal):** 0-8 (EV ~ 4.32 pts)
- **W / D / L:** 0% / 0% / 100%
- **lambda_home / lambda_away:** 0.21 / 8.91
- **Top scorelines:**
  - 0:8 (23%)
  - 0:7 (21%)
  - 0:6 (16%)
...
- **Why:** USA is the clear favourite. Recent form (last 5): TUR 3 wins, 1 draw, 1 loss; USA 2 wins, 3 losses. Past 3 meetings: TUR won 1, USA won 2. Model gives TUR 0%, draw 0%, USA 100%.
...
- **W / D / L:** 3% / 10% / 87%
- **lambda_home / lambda_away:** 0.59 / 3.24
- **Top scorelines:**
  - 0:3 (12%)
  - 0:2 (11%)
  - 0:4 (10%)
...
- **W / D / L:** 0% / 0% / 100%
- **lambda_home / lambda_away:** 0.08 / 23.93
- **Top scorelines:**
  - 0:8 (63%)
  - 0:7 (21%)
  - 0:6 (6%)
...
- **W / D / L:** 100% / 0% / 0%
- **lambda_home / lambda_away:** 7.01 / 0.27
- **Top scorelines:**
  - 7:0 (16%)
  - 6:0 (16%)
  - 8:0 (14%)
...
- **Why:** ESP is the favourite. Recent form (last 5): URU 1 win, 3 draws, 1 loss; ESP 2 wins, 3 draws. Past 3 meetings: ESP won 3. Model gives URU 3%, draw 10%, ESP 87%.
...
- **W / D / L:** 7% / 15% / 78%
- **lambda_home / lambda_away:** 0.72 / 2.66
- **Top scorelines:**
  - 0:2 (12%)
  - 0:3 (11%)
  - 1:2 (9%)
...
- **W / D / L:** 0% / 0% / 100%
- **lambda_home / lambda_away:** 0.14 / 13.29
- **Top scorelines:**
  - 0:8 (41%)
  - 0:7 (24%)
  - 0:6 (13%)
...
- **Why:** BEL is the clear favourite. Recent form (last 5): NZL 1 win, 4 losses; BEL 4 wins, 1 draw. Model gives NZL 0%, draw 0%, BEL 100%.
...
- **W / D / L:** 0% / 0% / 100%
- **lambda_home / lambda_away:** 0.12 / 16.34
- **Top scorelines:**
  - 0:8 (49%)
  - 0:7 (24%)
  - 0:6 (10%)
...
- **W / D / L:** 98% / 2% / 0%
- **lambda_home / lambda_away:** 5.33 / 0.36
- **Top scorelines:**
  - 5:0 (13%)
  - 4:0 (13%)
  - 6:0 (12%)
...
- **Why:** CRO is the clear favourite. Recent form (last 5): CRO 2 wins, 1 draw, 2 losses; GHA 1 draw, 4 losses. Model gives CRO 98%, draw 2%, GHA 0%.


### COL vs POR - Sat 27 Jun 23:30 UTC

- **Stage:** GROUP
- **Recommended pick (EV-optimal):** 0-1 (EV ~ 2.67 pts)
- **W / D / L:** 17% / 23% / 59%
- **lambda_home / lambda_away:** 0.97 / 1.96
- **Top scorelines:**
  - 1:1 (11%)
  - 0:2 (10%)
  - 1:2 (10%)
...
- **Why:** slight edge to POR. Recent form (last 5): COL 3 wins, 2 losses; POR 3 wins, 1 draw, 1 loss. Model gives COL 17%, draw 23%, POR 59%.


### COD vs UZB - Sat 27 Jun 23:30 UTC

- **Stage:** GROUP
- **Recommended pick (EV-optimal):** 1-0 (EV ~ 2.07 pts)
- **W / D / L:** 42% / 28% / 31%
- **lambda_home / lambda_away:** 1.51 / 1.27
- **Top scorelines:**
  - 1:1 (13%)
  - 2:1 (9%)
  - 1:0 (8%)
...
- **Why:** COD and UZB look evenly matched. Recent form (last 5): COD 3 draws, 2 losses; UZB 1 win, 2 draws, 2 losses. Model gives COD 42%, draw 28%, UZB 31%.
...
- **W / D / L:** 0% / 0% / 100%
- **lambda_home / lambda_away:** 0.03 / 66.83
- **Top scorelines:**
  - 0:8 (86%)
  - 0:7 (10%)
  - 1:8 (2%)
...
- **Stage:** GROUP
- **Recommended pick (EV-optimal):** 0-1 (EV ~ 1.88 pts)
- **W / D / L:** 36% / 28% / 36%
- **lambda_home / lambda_away:** 1.38 / 1.39
- **Top scorelines:**
  - 1:1 (13%)
  - 1:2 (8%)
  - 2:1 (8%)
...
### None vs None - Mon 29 Jun 17:00 UTC
...
- **W / D / L:** 100% / 0% / 0%
- **lambda_home / lambda_away:** 21.50 / 0.09
- **Top scorelines:**
  - 8:0 (60%)
  - 7:0 (22%)
  - 6:0 (7%)
...
- **W / D / L:** 100% / 0% / 0%
- **lambda_home / lambda_away:** 10.12 / 0.19
- **Top scorelines:**
  - 8:0 (28%)
  - 7:0 (23%)
  - 6:0 (16%)
...
- **Stage:** GROUP
- **Recommended pick (EV-optimal):** 8-0 (EV ~ 4.75 pts)
- **W / D / L:** 100% / 0% / 0%
- **lambda_home / lambda_away:** 13.39 / 0.14
- **Top scorelines:**
  - 8:0 (41%)
  - 7:0 (24%)
  - 6:0 (13%)
...
### None vs None - Fri 03 Jul 03:00 UTC
...
### None vs None - Fri 03 Jul 18:00 UTC
...
- **W / D / L:** 100% / 0% / 0%
- **lambda_home / lambda_away:** 56.43 / 0.03
- **Top scorelines:**
  - 8:0 (83%)
  - 7:0 (12%)
  - 8:1 (3%)
